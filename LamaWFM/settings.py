"""
Django settings for LamaWFM project.
...
SECRET_KEY = 'hc0s-4kb###_(xi$agxwyr8n1i$o)#^o6c#z6y(x4lp2^we6mt'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'wfm',
        'USER': 'postgres',
        'PASSWORD': 'Awir7bee', #'postgres',  #
        'HOST': '10.0.0.238',  #'10.0.4.110', #
        'PORT': '5432',
    }
}
